...
function onDeviceReady() {
  ...
  var sendNotification = (to, title, message) => {
    
    const serverKey = 'AAAAGL9LrQw:APA91bGLMn01d-FEDLPmoLECXxnzDX2izkblFlAc2rm0igZ3Vq5bebfAYaWezbbt07VjrdyCH8esJVQ4iZzKEC05OwsnT68KeVA3yl765B6XEesLiuYQx2W2gwxrppuoDSzMZq6EX3BK';
    const deviceToken = 'c98sXgqR_pg:APA91bEPK4-B6lgDpYmOwqs-m2kQ89JdGD8vLx99tfnLMjKcJQ4LRjpFgybft2N34nviXh2n_VsB1Yhf1t4MYPlhzt9btl81Pa4fsXUuQnju85Ij6zbJ4_XeVMsBSzbiA2ITJxdy4H_x';
  ...
  window.push.on("notification", (data) => {
    ...
    if (data.additionalData.button) { 
      notificationSetup['actions'] = [
        {id: data.additionalData.button?.toLowerCase().replace(' ', '-'), title: data.additionalData.button}
      ]
    }
