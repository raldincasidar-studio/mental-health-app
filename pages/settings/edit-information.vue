    ...
    <app-bar>
        <div class="container text-center">
            <h4 class="text-primary mb-8 grey--text">
                <v-icon size="60" class=" grey--text">mdi-account-edit</v-icon> <br>
...
export default {
    ...
    methods: {
        ...
        async signup() {
            ...
            const userData = await getDoc(doc(db, "user", this.userData.uid));
    ...
    mounted() {
        ...
        this.suffix = this.userData.suffix;
        ...
        this.confirm_password = this.userData.confirm_password;
    },
}
</script>