...
<app-bar>
    <div class="container text-center">
        ...
        <v-text-field v-if="page == 'signup'" v-model="middle_name" label="Middle Initial (Optional)" filled large class="my-1"></v-text-field>
    ...
    methods: {
        ...
        async signup() {
            ...
            if (
                ...
                ! /^\d{10}$/.test(this.phone_number)
            ) {
                this.errorCode = 'Phone number must be 10 digit'
                this.isLoading = false;
                return;
            }
